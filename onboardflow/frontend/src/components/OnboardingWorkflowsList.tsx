...
export default function OnboardingWorkflowsList() {
  ...
  if (loading) return <div>Loading OnboardingWorkflows...</div>;

  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">OnboardingWorkflows</h2>
      ...
      {data.length === 0 && <p>No OnboardingWorkflows found.</p>}
    </div>
  );
}
