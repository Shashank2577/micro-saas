...
export default function TaskAssignmentsList() {
  ...
  if (loading) return <div>Loading TaskAssignments...</div>;

  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">TaskAssignments</h2>
      ...
      {data.length === 0 && <p>No TaskAssignments found.</p>}
    </div>
  );
}
