...
export default function OnboardingFeedbackList() {
  ...
  if (loading) return <div>Loading OnboardingFeedback...</div>;

  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">OnboardingFeedback</h2>
      ...
      {data.length === 0 && <p>No OnboardingFeedback found.</p>}
    </div>
  );
}
