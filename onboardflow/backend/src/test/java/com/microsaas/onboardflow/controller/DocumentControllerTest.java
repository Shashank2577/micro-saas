...
public class DocumentControllerTest {
    ...
    public void testGetAll() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/onboardflow/documents")
    ...
    public void testCreate() throws Exception {
        ...
        when(service.create(eq(tenantId), any(DocumentRequest.class))).thenReturn(response);

        mockMvc.perform(post("/api/v1/onboardflow/documents")
                .header("X-Tenant-ID", tenantId.toString()).with(csrf())
