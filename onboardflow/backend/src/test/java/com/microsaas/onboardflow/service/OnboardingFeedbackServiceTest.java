...
public class OnboardingFeedbackServiceTest {

    @Mock
    private OnboardingFeedbackRepository repository;
    ...
    public void testCreate() {
        ...
        OnboardingFeedback savedEntity = new OnboardingFeedback();
        savedEntity.setName("Test");

        when(repository.save(any(OnboardingFeedback.class))).thenReturn(savedEntity);

        OnboardingFeedback result = service.create(tenantId, request);
