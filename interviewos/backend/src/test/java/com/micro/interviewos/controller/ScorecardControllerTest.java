...
@WebMvcTest(controllers = ScorecardController.class, excludeAutoConfiguration = {org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration.class})
class ScorecardControllerTest {
    ...
    void findAll_ShouldReturnList() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/interviews/scorecards")
    ...
    void findById_ShouldReturnDto() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/interviews/scorecards/{id}", id)
                .header("X-Tenant-Id", tenantId.toString()))
                .andExpect(status().isOk())
