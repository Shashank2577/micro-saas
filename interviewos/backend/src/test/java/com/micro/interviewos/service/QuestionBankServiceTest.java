...
class QuestionBankServiceTest {
    ...
    void findAll_ShouldReturnList() {
        ...
        List<QuestionBankDTO> result = service.findAll(tenantId);
    ...
    void findById_ShouldReturnDto() {
        ...
        Optional<QuestionBankDTO> result = service.findById(id, tenantId);
    ...
    void create_ShouldReturnDto() {
        when(repository.save(any(QuestionBank.class))).thenReturn(entity);

        QuestionBankDTO result = service.create(dto);
    ...
    void update_ShouldReturnDto() {
        ...
        QuestionBankDTO result = service.update(id, tenantId, dto);
