...
TRACKER="${REPO_ROOT}/.jules-dispatch-prod-wave-30-wave1.json"
LOG_FILE="${REPO_ROOT}/.jules-dispatch-prod-wave-30-wave1.log"
...
: > "$LOG_FILE"
echo "{\"wave\":\"dispatch-prod-wave-30-wave1\",\"apps\":{}}" > "$TRACKER"
...
dispatch_one "budgetpilot"
dispatch_one "ghostwriter"
dispatch_one "invoiceprocessor"
dispatch_one "jobcraftai"
dispatch_one "seointelligence"
dispatch_one "videonarrator"
dispatch_one "securitypulse"
dispatch_one "supportintelligence"
dispatch_one "auditready"
dispatch_one "constructioniq"
dispatch_one "contentos"
dispatch_one "dependencyradar"
dispatch_one "licenseguard"
dispatch_one "nexus-hub"
dispatch_one "policyforge"

echo "Dispatch completed for dispatch-prod-wave-30-wave1"
echo "Log: $LOG_FILE"
