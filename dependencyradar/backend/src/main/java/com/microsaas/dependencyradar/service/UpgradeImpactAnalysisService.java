...
public class UpgradeImpactAnalysisService {
    private final UpgradeImpactAnalysisRepository repository;

    public List<UpgradeImpactAnalysis> findAll() {
        String tenantId = "system";
        return repository.findByTenantId(tenantId);
    }

    public Optional<UpgradeImpactAnalysis> findById(UUID id) {
        String tenantId = "system";
        return repository.findByIdAndTenantId(id, tenantId);
    }

    public UpgradeImpactAnalysis save(UpgradeImpactAnalysis entity) {
        String tenantId = "system";
