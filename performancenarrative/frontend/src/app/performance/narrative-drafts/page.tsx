...
export default function NarrativeDraftsPage() {
  const [items, setItems] = useState<NarrativeDrafts[]>([]);
  ...
  const fetchItems = async () => {
    try {
      const data = await api.get("/performance/narrative-drafts");
      setItems(data);
    } catch (error) {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Narrative Drafts</h1>
