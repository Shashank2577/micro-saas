...
public class ReviewCycleService {
    ...
    public Optional<ReviewCycle> getById(UUID id) {
        return repository.findByIdAndTenantId(id, TenantContext.require());
    }

    public ReviewCycle create(ReviewCycle entity) {
    ...
    public ReviewCycle update(UUID id, ReviewCycle details) {
        ReviewCycle existing = repository.findByIdAndTenantId(id, TenantContext.require())
