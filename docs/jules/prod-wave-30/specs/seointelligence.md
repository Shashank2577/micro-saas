# SEOIntelligence — Production Progression Spec (Wave Upgrade)

## 1) Product Intent
- **App:** `seointelligence`
- **Domain:** Marketing Intelligence
- **Outcome:** Keyword opportunity, content gap analysis, and ranking movement intelligence
- **Primary actors:** SEO lead, Content strategist, Growth manager
...
- [ ] 1. keyword-clusters: backend service + controller + frontend page + tests
- [ ] 2. gap-analysis: backend service + controller + frontend page + tests
- [ ] 3. rank-tracking: backend service + controller + frontend page + tests
- [ ] 4. competitors: backend service + controller + frontend page + tests
- [ ] 5. optimization: backend service + controller + frontend page + tests
- [ ] 6. crawl-health: backend service + controller + frontend page + tests
...
| name | varchar(180) | KeywordCluster display name |
...
| id | UUID | Primary key |
| tenant_id | UUID | Tenant isolation key |
| name | varchar(180) | ContentGap display name |
| status | varchar(40) | Lifecycle status enum |
| metadata_json | jsonb | Extensible structured attributes |
| created_at | timestamptz | Creation timestamp |
| updated_at | timestamptz | Last updated timestamp |
...
| id | UUID | Primary key |
| tenant_id | UUID | Tenant isolation key |
| name | varchar(180) | RankSnapshot display name |
| status | varchar(40) | Lifecycle status enum |
| metadata_json | jsonb | Extensible structured attributes |
| created_at | timestamptz | Creation timestamp |
| updated_at | timestamptz | Last updated timestamp |
...
| id | UUID | Primary key |
| tenant_id | UUID | Tenant isolation key |
| name | varchar(180) | SERPCompetitor display name |
| status | varchar(40) | Lifecycle status enum |
| metadata_json | jsonb | Extensible structured attributes |
| created_at | timestamptz | Creation timestamp |
| updated_at | timestamptz | Last updated timestamp |
...
| id | UUID | Primary key |
| tenant_id | UUID | Tenant isolation key |
| name | varchar(180) | OptimizationPlan display name |
| status | varchar(40) | Lifecycle status enum |
| metadata_json | jsonb | Extensible structured attributes |
| created_at | timestamptz | Creation timestamp |
| updated_at | timestamptz | Last updated timestamp |
...
| id | UUID | Primary key |
| tenant_id | UUID | Tenant isolation key |
| name | varchar(180) | CrawlIssue display name |
| status | varchar(40) | Lifecycle status enum |
| metadata_json | jsonb | Extensible structured attributes |
| created_at | timestamptz | Creation timestamp |
| updated_at | timestamptz | Last updated timestamp |
...
- GET /api/v1/seo/keyword-clusters
- POST /api/v1/seo/keyword-clusters
- GET /api/v1/seo/keyword-clusters/{id}
- PATCH /api/v1/seo/keyword-clusters/{id}
- POST /api/v1/seo/keyword-clusters/{id}/validate
- GET /api/v1/seo/content-gaps
- POST /api/v1/seo/content-gaps
- GET /api/v1/seo/content-gaps/{id}
- PATCH /api/v1/seo/content-gaps/{id}
- POST /api/v1/seo/content-gaps/{id}/validate
- GET /api/v1/seo/rank-snapshots
- POST /api/v1/seo/rank-snapshots
- GET /api/v1/seo/rank-snapshots/{id}
- PATCH /api/v1/seo/rank-snapshots/{id}
- POST /api/v1/seo/rank-snapshots/{id}/validate
- GET /api/v1/seo/serpcompetitors
- POST /api/v1/seo/serpcompetitors
- GET /api/v1/seo/serpcompetitors/{id}
- PATCH /api/v1/seo/serpcompetitors/{id}
- POST /api/v1/seo/serpcompetitors/{id}/validate
- GET /api/v1/seo/optimization-plans
- POST /api/v1/seo/optimization-plans
- GET /api/v1/seo/optimization-plans/{id}
- PATCH /api/v1/seo/optimization-plans/{id}
- POST /api/v1/seo/optimization-plans/{id}/validate
- POST /api/v1/seo/ai/analyze
- POST /api/v1/seo/ai/recommendations
- POST /api/v1/seo/workflows/execute
- GET /api/v1/seo/health/contracts
- GET /api/v1/seo/metrics/summary

## 6) Service Layer Contract
Implement the following service modules with explicit method-level unit tests:
- keyword-clustersService: create/update/list/getById/delete/validate/simulate
- gap-analysisService: create/update/list/getById/delete/validate/simulate
- rank-trackingService: create/update/list/getById/delete/validate/simulate
- competitorsService: create/update/list/getById/delete/validate/simulate
- optimizationService: create/update/list/getById/delete/validate/simulate
- crawl-healthService: create/update/list/getById/delete/validate/simulate
...
- Backend:
  - `mvn -pl seointelligence/backend clean verify`
- Frontend:
  - `npm --prefix seointelligence/frontend test`
  - `npm --prefix seointelligence/frontend run build`
- Contract checks:
