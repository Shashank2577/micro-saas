...
import com.microsaas.compbenchmark.repositories.MarketDatasetRepository;
...
public class MarketDatasetService {
    ...
    public MarketDataset create(MarketDataset entity) {
    ...
    public List<MarketDataset> list() {
        return repository.findByTenantId(TenantContext.require());
    }

    public MarketDataset getById(UUID id) {
        return repository.findByIdAndTenantId(id, TenantContext.require())
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Not found"));
    }

    public MarketDataset update(UUID id, MarketDataset updates) {
        MarketDataset existing = getById(id);
